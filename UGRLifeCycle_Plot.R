...
ggplot(summary) +
    ...
    labs(y = "Eggs", title = "Natural + Hatchery Eggs", subtitle = model_name) +
...
ggplot(summary) +
    ...
    labs(y = "Parr", title = "Late Summer Parr", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
...
ggplot(summary) +
    ...
    labs(y = "LGD Smolt", title = "Natural Smolt at LGD", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
...
ggplot(summary) +
    ...
    labs(y = "Hatcyery LGD Smolt", title = "Hatchery Smolt at LGD", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
...
ggplot(summary) +
    ...
    labs(y = "Natural Returns", title = "Natural Returns to Trap", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
...
ggplot(summary) +
    ...
    labs(y = "Hatchery Returns", title = "Hatchery Returns to Trap", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
...
ggplot(summary) +
    ...
    labs(y = "Total Returns", title = "Total Returns to Trap", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
...
ggplot(summary) +
    ...
    labs(y = "Natural Brood", title = "Natural Brood Retained", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
...
ggplot(summary) +
    ...
    labs(y = "Hatchery Brood", title = "Hatchery Brood Retained", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
...
ggplot(summary) +
    ...
    labs(y = "Natural Spawners", title = "Natural Spawners", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
...
ggplot(summary) +
    ...
    labs(y = "Hatchery Spawners", title = "Hatchery Spawners", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
...
ggplot(summary) +
    ...
    labs(y = "Total Spawners", title = "Total Spawners", subtitle = model_name) +
    theme(axis.text = element_text(size=12,face="bold"),
        axis.title = element_text(size=14,face="bold"),
        plot.title = element_text(size=18, face="bold"),
        plot.subtitle = element_text(size=14, face="bold", color = "darkgray"))
